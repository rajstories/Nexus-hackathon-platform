      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 w-full">
          <div className="grid lg:grid-cols-7 gap-6 items-center">
            ...
            <motion.div 
              {...fadeInRight}
              className="lg:col-span-4 relative flex items-center justify-end pl-8"
            >
              <div className="relative w-full max-w-lg">
                ...
                <motion.div 
                  ...
                  className="absolute top-32 -left-16 bg-slate-800/80 backdrop-blur-sm border border-orange-400/30 rounded-lg p-3 shadow-lg"
                >
                  <motion.div 
